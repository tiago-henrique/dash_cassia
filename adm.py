...
with col3:
    ...
    # if int(atb_perc.iloc[0, 1]) > 100:
    #     atb_meta_ok = 'Bateu a meta';
    # else:
    #     atb_meta_ok = 'Não bateu a meta';
    # st.write(atb_meta_ok)
...
st.markdown("<footer>Desenvolvido por Cassia Estofolete e Tiago Henrique</footer>", unsafe_alow_html=True)
